...
/**
 * Controller della vista "Visualizza libro".
 * <p>
 * Costruisce l'interfaccia con barra di ricerca e lista risultati,
 * esegue la ricerca asincrona delle informazioni del libro per titolo tramite il servizio client
...
public class viewInfoController {
     ...
     */
    public viewInfoController(Bookapp mainApp, ClientService clientService) {
    ...
    private void createView() {
        ...
        Label label = new Label("Visualizza libro:");
        ...
        backBtn.setOnAction(e -> {
            try {
                ...
                System.err.println("Errore nel ritorno al Repository: " + ex.getMessage());
            }
        });
    ...
    /**
     * Esegue la ricerca delle informazioni del libro per il titolo inserito:
     * - valida l'input e mostra un messaggio se vuoto,
     * - lancia un Task asincrono che interroga il server (azione 1),
    ...
    private void performSearch() {
        ...
        Task<String> searchTask = new Task<>() {
            ...
            protected String call() throws Exception {
                return clientService.VisualizzaLibro(titolo, 1);
            }
        };
