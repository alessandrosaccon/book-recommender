...
/**
 * Gestisce la vista e la logica per la ricerca di libri in base al titolo.
 * Costruisce l'interfaccia utente con un campo di testo per il titolo e una lista
 ...
 * @version 1.0
 */
public class ricercaTitoloController {
     ...
     * Campo di testo per l'inserimento del titolo da cercare.
     */
     ...
     */
    public ricercaTitoloController(Bookapp mainApp, ClientService clientService) {
    ...
    /**
     * Costruisce l'interfaccia utente (UI) per la ricerca per titolo.
     * Configura l'etichetta, il campo di testo per il titolo,
    ...
    private void createView() {
        ...
        topBar.getChildren().addAll(Vbox);
    ...
    /**
     * Esegue la ricerca dei libri per titolo.
     * Recupera il testo dal campo <code>searchLibro</code>, valida che non sia vuoto
     * e avvia un Task asincrono per chiamare il <code>clientService.ricercaPerTitolo()</code>.
     ...
     * @see client.ClientService#ricercaPerTitolo(String)
     */
    ...
    private void performSearch() {
        ...
        Task<LinkedList<Libro>> searchTask = new Task<>() {
            ...
            protected LinkedList<Libro> call() throws Exception {
                return clientService.ricercaPerTitolo(titolo);
            }
        };
